...
import TeacherCommentsApi from '@/api/teacher/comments.js'
export default {
  components: {
  ...
  methods: {
    fetchComment () {
      ...
      TeacherCommentsApi.getComments(coursecode, pid, _comment => {
    ...
    addComment (ref, content) {
      ...
      var coursecode = meat.substring(0, 5)
      var pid = meat.slice(-1)
      TeacherCommentsApi.createComment(coursecode, pid, content, newComment => {
